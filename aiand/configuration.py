...
class Configuration:
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://api.aiand.com" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("aiand")
    ...
    def debug(self, value: bool) -> None:
        ...
        if self.__debug:
            ...
            # Keep low-level HTTP debug disabled; it writes raw headers,
