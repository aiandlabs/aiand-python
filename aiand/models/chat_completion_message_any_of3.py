...
class ChatCompletionMessageAnyOf3(BaseModel):
    """
    ChatCompletionMessageAnyOf3
    """ # noqa: E501
    role: StrictStr
    content: Optional[ChatCompletionMessageAnyOf3Content] = None
    refusal: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    tool_calls: Optional[List[ChatCompletionMessageAnyOf3ToolCallsInner]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["role", "content", "refusal", "name", "tool_calls"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "role": obj.get("role"),
            "content": ChatCompletionMessageAnyOf3Content.from_dict(obj["content"]) if obj.get("content") is not None else None,
