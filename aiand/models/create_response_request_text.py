...
class CreateResponseRequestText(BaseModel):
    """
    Configuration for text response format (text, json_object, json_schema).
    """ # noqa: E501
    format: Optional[CreateResponseRequestTextFormat] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "format": CreateResponseRequestTextFormat.from_dict(obj["format"]) if obj.get("format") is not None else None
        })
