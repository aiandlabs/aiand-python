...
class ListModels200Response(BaseModel):
    ...
    """ # noqa: E501
    object: StrictStr
    data: List[ListModels200ResponseDataInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [ListModels200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
