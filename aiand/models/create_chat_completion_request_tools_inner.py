...
class CreateChatCompletionRequestToolsInner(BaseModel):
    """
    CreateChatCompletionRequestToolsInner
    """ # noqa: E501
    type: StrictStr
    function: CreateChatCompletionRequestToolsInnerFunction
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "function": CreateChatCompletionRequestToolsInnerFunction.from_dict(obj["function"]) if obj.get("function") is not None else None
        })
