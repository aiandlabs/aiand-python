...
class CreateChatCompletionResponseChoicesInnerMessage(BaseModel):
    """
    ...
    tool_calls: Optional[List[ChatCompletionMessageAnyOf3ToolCallsInner]] = None
    annotations: Optional[List[CreateChatCompletionResponseChoicesInnerMessageAnnotationsInner]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["role", "content", "refusal", "tool_calls", "annotations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tool_calls": [ChatCompletionMessageAnyOf3ToolCallsInner.from_dict(_item) for _item in obj["tool_calls"]] if obj.get("tool_calls") is not None else None,
            "annotations": [CreateChatCompletionResponseChoicesInnerMessageAnnotationsInner.from_dict(_item) for _item in obj["annotations"]] if obj.get("annotations") is not None else None
        })
