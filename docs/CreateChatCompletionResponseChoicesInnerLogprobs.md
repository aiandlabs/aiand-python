...
------------ | ------------- | ------------- | -------------
**content** | [**List[CreateChatCompletionResponseChoicesInnerLogprobsContentInner]**](CreateChatCompletionResponseChoicesInnerLogprobsContentInner.md) |  | 
**refusal** | [**List[CreateChatCompletionResponseChoicesInnerLogprobsContentInner]**](CreateChatCompletionResponseChoicesInnerLogprobsContentInner.md) |  | 
